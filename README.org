...
Make sure to have [[https://nixos.org/][nix]] installed, enter the dev environment with
#+BEGIN_SRC bash
nix-shell shell.nix
#+END_SRC
...
** Gen7Net.ipynb
jupyter-notebook for Gen7Net. I recommend running it with [[www.colab.google.com][Google Colab]].
In order to run it locally, I recommend using [[www.docker.com][docker containers]] with a tensorflow packaging tool
